    ...
    <>
      ...
      <div className="p-6 border-b border-gray-800">
        <Link href="/admin" className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-purple-400 text-xs">Admin Portal</p>
          </div>
        </Link>
      </div>
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        {navigation.map((item) => {
          ...
          return (
            ...
            >
              <item.icon className={`h-5 w-5 ${isActive ? "text-purple-400" : "text-gray-500 group-hover:text-gray-300"}`} />
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="flex items-center gap-3 px-4 py-3 mb-2">
          <div className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white font-semibold">CA</div>
          <div className="flex-1 min-w-0">
            <p className="text-white font-medium truncate">College Admin</p>
            <p className="text-gray-500 text-sm truncate">admin@university.edu</p>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-72 lg:fixed lg:inset-y-0 bg-gray-950 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 -right-20 w-60 h-60 bg-pink-500/20 rounded-full blur-3xl" />
