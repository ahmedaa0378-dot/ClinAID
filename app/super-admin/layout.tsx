...
const menuItems = [
  ...
  { icon: Building, label: "Colleges", href: "/super-admin/colleges" },
  ...
  { icon: FileText, label: "Audit Logs", href: "/super-admin/logs" },
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-[#BE123C] text-white"
      >
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-[#BE123C] to-[#9F1239] transition-transform duration-300 ease-in-out z-40 ${
        ...
        <div className="flex flex-col h-full p-6">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-white transition-colors duration-200 ${
                    active ? "bg-[#E11D48]" : "hover:bg-[#DB2777]"
                  }`}
                >
          ...
          <div className="mt-auto">
            <div className="space-y-1 mb-4">
              <Link
                href="/"
                className="flex items-center gap-2 px-4 py-2 text-rose-200 hover:text-white transition-colors text-sm"
              >
                ← Student View
              </Link>
              <Link
            ...
            <div className="bg-[#DB2777] rounded-xl p-4 space-y-3">
              <div className="flex items-center gap-2">
                <HelpCircle className="h-5 w-5 text-white" />
                <span className="text-white font-semibold">Platform Status</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse" />
                <span className="text-white/90 text-sm">All systems operational</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1 max-w-xl">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search colleges, users..."
            ...
            <div className="flex items-center gap-4 ml-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-rose-100 flex items-center justify-center">
                  <span className="text-rose-700 font-medium">SA</span>
                </div>
